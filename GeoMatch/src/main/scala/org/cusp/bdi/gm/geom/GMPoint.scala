...
/**
  ...
  */
case class GMPoint(_payload: String, _pointCoord: (Double, Double)) extends GMGeomBase(_payload, Array(_pointCoord)) {

    override def clone() =
        new GMPoint(new String(_payload), (_pointCoord._1, _pointCoord._2))
