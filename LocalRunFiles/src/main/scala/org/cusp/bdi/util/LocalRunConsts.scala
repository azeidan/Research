...
object LocalRunConsts {
  ...
  val pathGM_TPEP = "/media/cusp/Data/GeoMatch_Files/OutputFiles/Simba/Bus_1_Grp1/"
  val pathSparkKNN_FW_Output_1 = pathGM_TPEP
  val pathSparkKNN_FW_Output_2 = "/media/cusp/Data/GeoMatch_Files/OutputFiles/430/"
